...
In the file “subjects_info.xlsx” the “Count quality” column provides info which subjects correspond to which group (0 - Group ”B”, 1 - Group “G”). Additionally, file “subjects-info.csv” provides basic information about each subject (gender, age, job, date of recording).
